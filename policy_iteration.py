import numpy as np
from modified_policy_iteration import modified_policy_iteration, SellingAssetProblem, animate_mpi,calculated_threshold, plot_convergence


problem = SellingAssetProblem(N=1000, alpha=0.9, C=10)
V, policy, V_hist, pi_hist, convergence_norms, runtime = modified_policy_iteration(problem,policy_iter=10000)
